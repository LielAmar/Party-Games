...
public class JungleJump extends Minigame implements Listener {
    ...
    public void setupMinigame() {
        ...
        for(int i = 0; i < super.getGame().getPlayers().length; i++) {
            ...
            super.getGame().getPlayers()[i].getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 99999, 3));
